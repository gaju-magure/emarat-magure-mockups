    ...
    items: [
      {
        ...
        children: [
          { id: 'ask', label: 'Ask MagVisionIQ', icon: 'SparklesIcon', path: '/magvision/ask' },
          { id: 'footfall', label: 'Footfall & Heat Maps', icon: 'MapIcon', path: '/magvision/footfall' },
          { id: 'sales', label: 'Sales & Revenue', icon: 'CurrencyDollarIcon', path: '/magvision/sales' },
          { id: 'inventory', label: 'Inventory', icon: 'CubeIcon', path: '/magvision/inventory' },
          { id: 'queue', label: 'Queue Monitoring', icon: 'UsersIcon', path: '/magvision/queue' },
          { id: 'staff', label: 'Staff & Scheduling', icon: 'CalendarIcon', path: '/magvision/staff' },
          { id: 'security', label: 'Security & Compliance', icon: 'ShieldCheckIcon', path: '/magvision/security' },
          { id: 'reports', label: 'Reports', icon: 'DocumentTextIcon', path: '/magvision/reports' },
        ],
      },
      {
        id: 'forecasting',
